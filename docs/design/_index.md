...
New here? Start with the [Design Overview](overview/) for the guiding constraints,
then [How it all works](architecture/) for the end-to-end mechanics. The individual
